...
func init() {
	registerToCheck(map[string][]any{
		...
		"egress_gw_steer_key":    {egressmap.EgressSteerKey4{}},
		"egress_gw_steer_val":    {egressmap.EgressSteerVal4{}},
		"egress_gw_reverse_key":  {egressmap.EgressReverseKey4{}},
		"egress_gw_reverse_val":  {egressmap.EgressReverseVal4{}},
